...
public class BEIV01SoundListener : MonoBehaviour, EventListener<SoundChannel>
{
    public void OnMMEvent(SoundChannel eventType)
    {
        switch (eventType.EventName)
        {
            ...
            case SoundChannel.PAUSE_SOUND:
                SoundManager.Instance.StopFxOneShot(); // [Note] Stop PlayFxOnNewGameObject
                break;
            case SoundChannel.STOP_SOUND:
                SoundManager.Instance.StopFx(); // [Note] Stop PlayFx
                break;
        }
    }
